...
drop table if exists DISPIELE.ITEM;
...
drop table if exists DISPIELE.CUSTOMER;
...
drop table if exists DISPIELE.USER; 
...
drop table if exists DISPIELE.ORDER;
...
drop table if exists DISPIELE.ORDER_HISTORY;
